    ...
    class Calculator
    {
        ...
        public static void FillStack(string expression)
        {
            ...
            for (int i = 0; i < expression.Length; i++)
            {
                ...
                if (expression[i] is 's' or 'c' or 't' or 'g' or 'e' or 'l' or 'n' or '$' or '@' or 'a' or '!')
                {

                    if (expression[i] == '!')
                    {
                        LeksemaOperationToStack(TrigonometricFunstions["fac"]);
                        continue;
                    }
        ...
        private static int GetRang(char ch)
        {
            ...
            if (ch is '^') return 3;
            if (ch is 's' or 'c' or 't' or 'g' or 'e' or 'l' or 'n' or '$' or '@' or 'a' or '!') return 4;
            else return 0;
        }
